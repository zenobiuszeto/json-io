...
public class JsonReader extends Reader
{
	...
	private static class JsonObject<K,V> extends LinkedHashMap<K,V>
	{
	...
	public Object readObject() throws IOException
	{
		...
		Object graph = convertMapsToObjects((JsonObject) o);
	...
	{
        Deque<JsonObject> stack = new LinkedList<JsonObject>();
        stack.push(root);
	 ...
	 */
	private void traverseArray(Deque stack, JsonObject jsonObj) throws IOException
	{		
    ...
    private void traverseFields(Deque stack, JsonObject<String, Object> jsonObj) throws IOException
    {
        Object javaMate = jsonObj.target;
	 ...
	 */
	private void assignField(Deque stack, JsonObject jsonObj, Field field, Object rhs) throws IOException
	{
	...
	private Object newInstance(Class c) throws IOException
	{
		...
		catch (Exception e)
		{
            ...
            {
                throw new IOException("Could not instantiate class '" + c.getName() + "' at position " + _in.getPos());
            }
		}
	}
